...
public class App_v2 {
	...
	public static void main(String[] args) {
		...
		ExecutorService executor = Executors.newFixedThreadPool(numMineros);
		...
		int sumaBolsas = 0;
		for (int i = 0; i < ejercitoMineros.length; i++) {
			System.out.println("El minero " + ejercitoMineros[i].getNombre() + " ha recolectado " + ejercitoMineros[i].getBolsa() + " oros.");
